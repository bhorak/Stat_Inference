...
is approximatly normal, even with a small bin size.  
...
Simulated coverage for `r nosim` replications and `r n` sample size. The coverage
for the confidence interval is about `r coverage` %.
